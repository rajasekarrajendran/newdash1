const mapp = angular.module('ngFlash', []);
...
mapp.directive('mapplytransclude', [
    '$compile', function($compile) {
        return {
            restrict: 'A',
            link: function(scope, ele, attrs) {
